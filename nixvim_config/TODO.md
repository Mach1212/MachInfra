...
- setup biome to have default eslint rules and merge extra rules/conflicting rules from project
- Telescope live_grep results should be in the middle of the screen
